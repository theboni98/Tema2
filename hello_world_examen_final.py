...
'''
Se pueden usar cualquier version de Numpy y tambien cualquier version de OpenCv
'''
...
class perceptron_multipaca:
	...
	def subir_patrones_entrenamiento(self):
		#inge con este metodo puede subir todos los patrones de entrenamiento y crea la matriz de Quetzales 
	...
	def realizar_perceptron_multicapa(self):
		#con el metodo principal realize este procedimiento de la red 
	...
	def nuevos_pesos(self,matriz_pesos, error,entrada , alfa):
		#use este metodo para que encontrara los nuevos pesos de la matriz de prueba 
		return matriz_pesos + (alfa* np.dot(error,entrada))
				
	def subir_patron_de_prueba(self, nombre_patron):
		#inge en este le agrgue sonido al patorn de prueba
	...
	def probar_patron_de_prueba(self):
		#inge aqui puse el metodo de como subi el patron de prueba de los mismos que se tomaron paraentrenar la red 
	...
	def patron_encontrado(self, maximo):
		#aqui esta el metodo que use para guardar el patron encontrado, este se guardara como imagen.bmp 
...
#fin del hello world ahAHHAHAAHAHHA